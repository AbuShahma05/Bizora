...
const PricingSection = () => {
  // State to manage product count
  const [productCount, setProductCount] = useState(1);

  // Dynamically calculate plan prices based on the product count
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-blue-200 p-8 rounded-lg shadow-lg"
          >
            <motion.h3
        ...
        <motion.div variants={fadeIn("up", 0.8)} className="max-w-xl mx-auto">
          ...
          <motion.div variants={fadeIn("up", 1.0)} className="relative px-4">
            <div className="flex items-center gap-2">
              <span className="text-xs sm:text-sm text-blue-600">1</span>
              <input
                type="range"
                min="1"
                max="50"
              ...
              />
              <span className="text-xs sm:text-sm text-blue-600">50</span>
            </div>
          </motion.div>
