...
const NewsletterSection = () => {
  return (
    <section id="wwoffer" className="section-container px-4 md:px-0">
      <motion.div
        ...
        <div className="relative md:px-16 px-6 py-16 md:py-24">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            ...
            >
              ...
              >
                Bizora brings the best tools and strategies to your
                service—seamless, efficient, and designed to drive your business
                growth
              </motion.p>
            </motion.div>
