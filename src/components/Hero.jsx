  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
         Access precise leads, expert sales training, conversion tools, and more—all under one simple billing plan.
        </motion.p>
